...
<div class="main-div">
<h2 class="title text-center">List of Hotels in Shylet City</h2>
...
$sql="select count(*) as total from hotel where Location='Shylet'";
...
$selectquery="select * from hotel where Location='Shylet'";
