...
<body>
  ...
  <div class="main-div">
    <h2 class="title text-center">List of Hotels in Chittagong City</h2>
    <div class="center-div">
      <div class="table-responsive">
        <table>
          ...
          <tbody>
            ...
            $sql = "select count(*) as total from hotel where Location='Chittagong'";
      ...
      <div class="container">
        ...
        <table>
          <thead>
            <tr>
              <th>Total Number Of Hotels in Chittagong</th>
            </tr>
          </thead>
          <tr>
