...
<input type="text" name="trainno" class="form-control" id="trainno" aria-describedby="emailHelp" placeholder="Train Number">
</div>
<div class="form-group">
    <label for="name">Name</label>
    <input type="text" name="name" class="form-control" id="name" placeholder="Train Name" required>
  </div>
<div class="form-group">
    <label for="fromcity">From</label>
    <input type="text" name="fromcity" class="form-control" id="fromcity" placeholder="From City" required>
  </div>
  <div class="form-group">
    <label for="tocity">To</label>
    <input type="text" name="tocity" class="form-control" id="tocity" placeholder="To City" required>
  </div>
  <div class="form-group">
    <label for="arrival">Arrival Time</label>
    <input type="text" name="arrival" class="form-control" id="arrival" placeholder="Arrival Time" required>
  </div>
  <div class="form-group">
    <label for="departure">Departure Time</label>
    <input type="text" name="departure" class="form-control" id="departure" placeholder="Departure Time" required>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" name="class" class="form-control" id="class" placeholder="Class" required>
  </div>
